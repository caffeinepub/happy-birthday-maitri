...
export class Backend implements backendInterface {
    ...
    async deleteMessage(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMessage();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMessageByAuthor(arg0: Principal): Promise<Message> {
        if (this.processError) {
            try {
                const result = await this.actor.getMessageByAuthor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
